@isset( $collection_points )
    ...
    @forelse($pointsOfCollection as $key=>$collection_points )
      <details class="row regional-collection-points mb-lg-3 mb-4" @if( $counter === 0 ) open @endif>
        <summary class="p-lg-3 p-0">{{ ucwords( $key ) }}</summary>
        @foreach( $collection_points as $k=>$option)
          ...
          <div class="content col-12 local-collection-points mb-lg-3 mb-2" style="border-bottom:1px solid #f0f0f0;">
            <div class="row no-gutters my-lg-2 my-3">

              <div class="col-auto col-lg-1 mt-1 mt-lg-0 text-center">
                @php
              ...
              <div class="col-12 col-lg-1 mt-1 mt-lg-0">
                R {{ number_format( $option->shipping_cost, 2, ".", "" ) }}
              </div>
                ...
                <details class="mt-lg-2 mt-3">
                  ...
                  <div class="content row">
                    ...
                    <div class="col-12 @isset( $impossible_variable ) col-lg-7 @else col-lg-12 @endisset mt-3 mt-lg-0">
                      @isset( $option->id )
                        <div style="width:100%;height:250px;" class="collect-maps" id="map_{{ $option->id }}"></div>
                      @endisset
                    </div>
                    @endisset
